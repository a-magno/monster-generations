...
##TODO: transform this into a Resource type
## with params: type (enum), weaknesses, resistances and immunities (arrays of enum)
## and a function to check if atk_type in weak/res/immun for type advantage/disadvantages
